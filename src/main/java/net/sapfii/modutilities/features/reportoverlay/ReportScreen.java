...
public class ReportScreen extends WidgetContainerScreen {
    ...
    public ReportScreen() {
        ...
        reportList = Widgets.create(VerticalListWidget::new)
                .withDimensions(300, reports.isEmpty() ? 30 : ModUtilities.MC.getWindow().getScaledHeight() - 50, true)
                .withPadding(2, 12, 6, 2);
